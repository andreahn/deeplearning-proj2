...
class ResNet50_layer4(nn.Module):
    def __init__(self, num_classes= 10 ): # Hint : How many classes in Cifar-10 dataset?
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 64, 7, 2, 3), #Parameters filled in by me here
            ...
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(3, 2, 1) #Parameters filled in by me here
        )
        self.layer2 = nn.Sequential(
            ResidualBlock(64, 64, 256, False), #Parameters filled in by me here
            ResidualBlock(256, 64, 256, False), #Parameters filled in by me here
            ResidualBlock(256, 64, 256, True) #Parameters filled in by me here
        )
        ...
        self.fc = nn.Linear(1024, num_classes) #Parameters filled in by me here
        self.avgpool = nn.AvgPool2d(2, 1) #Parameters filled in by me here
